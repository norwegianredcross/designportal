 ...
 * the right scheme from the first byte (see RootLayout); this script
 * starts after hydration and keeps the cookie in step with the toggle
 * by watching the attribute. A cookie rather than localStorage
