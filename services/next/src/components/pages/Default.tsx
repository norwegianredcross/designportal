...
/** Same controller/region/part flow as CMS100003-webpage. The documentation
 * extension adds a sidebar and a fixed generated section after the main region.
 * Keep the real render mode so Content Studio retains its editable region markers.
 */
