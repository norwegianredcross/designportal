...
/** Codegen reads the shared fragment names above. At runtime the adapter
 * concatenates page and part queries without deduplicating fragments, so give
 * each query's fragment definitions and references a matching scope.
 */
