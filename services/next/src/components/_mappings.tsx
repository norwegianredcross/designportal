/** Maps XP page controllers and placed parts to their queries and React views.
 * Like CMS100003-webpage, page templates decide the composition. A direct
 * content-type mapping would override that choice and bypass editable regions.
 */
