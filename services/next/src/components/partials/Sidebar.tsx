...
export function Sidebar({ currentPath, nav, meta }: SidebarProps) {
  // Sections show their children; articles show sibling pages.
  ...
  // Empty top-level sections must not repeat the main menu.
  ...
  // Group by kicker while preserving the content-tree order.
